      ...
      <div style={{ height: '75vh' }} className='container valign-wrapper'>
        <div className='row'>
          <div className='col s12 center-align'>
            <h4>
              <b>Secure Cloud Storage</b> for the online{' '}
              <span style={{ fontFamily: 'monospace' }}>generation</span>
            </h4>
            <p className='flow-text grey-text text-darken-1'>
              CrowdCloud is a secure cloud storage platform where you can store and share all
              your files.
              <br />
              You can access them on any device, download and share anywhere you go!
            </p>
            <br />
